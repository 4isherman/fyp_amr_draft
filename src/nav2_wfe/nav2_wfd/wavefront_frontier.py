...
class WaypointFollowerTest(Node):
    ...
    def __init__(self):
        ...
        # self.costmapClient = self.create_client(GetCostmap, '/global_costmap/costmap')
        ...
        self.model_pose_sub = self.create_subscription(Odometry,
          '/odometry/filtered', self.poseCallback, 10) # pose_qos)
        ...
        self.costmapSub = self.create_subscription(OccupancyGrid(), '/global_costmap/costmap', self.occupancyGridCallback, pose_qos)
        self.costmap = None
